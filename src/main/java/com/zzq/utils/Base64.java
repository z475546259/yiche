...
public class Base64 {
    ...
    static class Decoder extends Coder {
        ...
        L_0x0133:
            ...
            goto L_0x005d;
            */
//            throw new UnsupportedOperationException("Method not decompiled: com.yiche.price.tool.Base64.Decoder.process(byte[], int, int, boolean):boolean");
            return true;
        }
    }
    ...
    static class Encoder extends Coder {
        ...
        L_0x0247:
            ...
            goto L_0x0052;
            */
//            throw new UnsupportedOperationException("Method not decompiled: com.yiche.price.tool.Base64.Encoder.process(byte[], int, int, boolean):boolean");
            return true;
        }
    }
    ...
    public static String decodeToString(String ori) {
        try {
            return new String(decode(ori, 0));
        } catch (Exception e) {
            e.printStackTrace();
            return ori;
        }
